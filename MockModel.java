...
public class MockModel implements MarbleSolitaireModel {
  ...
  public MockModel(StringBuilder gameRecord) {
   ...
   *
   * Instead of changing model to actually move pieces, adds the move to the readable
   *
  ...
  public void move(int fromRow, int fromCol, int toRow, int toCol) throws IllegalArgumentException {
    this.gameRecord.append(String.format("fromRow = %d, fromCol = %d, toRow = %d, toCol = %d\n",
